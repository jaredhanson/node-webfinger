...
var httpHostMeta = function(address, callback) {
    ...
    request(http, options, {"application/json": jrd, "text/xml": xrd2jrd, "application/xrd+xml": xrd2jrd}, callback);
};
...
var httpsHostMeta = function(address, httpsOnly, callback) {
    ...
    request(https, options, {"application/json": jrd, "text/xml": xrd2jrd, "application/xrd+xml": xrd2jrd}, callback);
};
...
var lrdd = function(resource, options, callback) {
    ...
    Step(
        ...
        function(err, hm) {
            ...
            if (xrd && xrd.length > 0) {
                template(xrd[0].template, resource, {"text/xml": xrd2jrd, "application/xrd+xml": xrd2jrd}, options.httpsOnly, this);
                return;
            }
